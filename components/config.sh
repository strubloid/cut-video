...
export DND_PRE_ROLL="${DND_PRE_ROLL:-0.15}"
export DND_POST_ROLL="${DND_POST_ROLL:-0.20}"
export DND_MIN_REMOVE_DURATION="${DND_MIN_REMOVE_DURATION:-1.20}"
...
export DND_KEEP_PIECES="${DND_KEEP_PIECES:-}"
