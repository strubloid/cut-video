...
export DND_CHUNK_SIZE="${DND_CHUNK_SIZE:-50}"
export DND_CROSSFADE_MS="${DND_CROSSFADE_MS:-20}"
export DND_RENDER_THREADS="${DND_RENDER_THREADS:-}"
export DND_USE_GPU="${DND_USE_GPU:-auto}"
export DND_VIDEO_CRF="${DND_VIDEO_CRF:-18}"
export DND_AUDIO_BITRATE="${DND_AUDIO_BITRATE:-192k}"
export DND_KEEP_CHUNKS="${DND_KEEP_CHUNKS:-1}"
